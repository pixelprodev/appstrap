...
const { ACTIVATE_FIXTURE, DEACTIVATE_FIXTURE, SET_ENDPOINT_ENABLED, SET_MODIFIER } = require('./Config/constants')
...
class Interactor {
  ...
  setEndpointEnabled ({ key, method, enabled }) {
    this.dispatch({ type: SET_ENDPOINT_ENABLED, key, method, enabled })
  }
