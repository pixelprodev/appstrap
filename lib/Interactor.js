class Interactor {
  constructor ({ handlers, fixtures }) {
    ...
    this.routeMap = [
      { route: 'setHandlerEnabled', method: 'post', handler: this.setHandlerEnabled },
      { route: 'setModifier', method: 'post', handler: this.setModifier },
      { route: 'clearModifiers', method: 'get', handler: this.clearModifiers },
      { route: 'getStatus', method: 'get', handler: this.getStatus },
      { route: 'activateFixture', method: 'post', handler: this.activateFixture },
      { route: 'activateFixtures', method: 'post', handler: this.activateFixtures },
      { route: 'deactivateFixture', method: 'post', handler: this.deactivateFixture },
      { route: 'injectState', method: 'post', handler: this.injectState },
      { route: 'addResponseSequence', method: 'post', handler: this.addResponseSequence }
    ]
  }
